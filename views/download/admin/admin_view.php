...
if (!$small) {
    ...
    $this->params['breadcrumbs'][] = ['label' => $model->article->title, 'url' => ['admin/view', 'id' => $model->file->article_id]];
...
$attributes = [
	...
	[
		...
		'value' => function ($model) {
			...
			return Html::a($downloads, ['download/history/manage', 'download' => $model->primaryKey], ['title' => Yii::t('app', '{count} histories', ['count' => $downloads])]);
		},
		'format' => 'html',
		'visible' => !$small,
	],
