...
if ($download != null) {
	$this->params['breadcrumbs'][] = ['label' => $download->article->title, 'url' => ['admin/view', 'id' => $download->file->article_id]];
	...
	$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Download'), 'url' => ['download/admin/manage', 'file' => $download->file_id]];
} else {
	$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Download'), 'url' => ['download/admin/index']];
}
...
<?php if ($download != null) {
    echo $this->render('/download/admin/admin_view', ['model' => $download, 'small' => true]);
} ?>
