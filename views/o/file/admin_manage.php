...
$this->params['menu']['content'] = [
	...
	['label' => Yii::t('app', 'Add File'), 'url' => !Yii::$app->request->get('article') ? Url::to(['create']) : Url::to(['create', 'article' => Yii::$app->request->get('article')]), 'icon' => 'plus-square', 'htmlOptions' => ['class'=>'btn btn-success']],
];
