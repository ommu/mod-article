...
$fileFilename = !$model->isNewRecord && $model->old_file_filename != '' ? Html::a($model->old_file_filename, Url::to(join('/', ['@webpublic', $uploadPath, $model->old_file_filename])), ['title' => $model->old_file_filename, 'target' => '_blank', 'class' => 'd-inline-block mb-4']) : '';
