...
array_push($columnData, [
	...
	'buttons' => [
		'view' => function ($url, $model, $key) {
			return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'Detail Tag'), 'class' => 'modal-btn']);
		},
	...
	'template' => $article || $tag ? '{view} {delete}' : '{delete}',
]);
