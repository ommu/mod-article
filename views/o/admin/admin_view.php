...
<div class="box">
	<?php $this->widget('application.libraries.core.components.system.FDetailView', array(
		...
		'attributes'=>array(
			...
			array(
				'name'=>'published_date',
				'value'=>!in_array($model->published_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00')) ? Utility::dateFormat($model->published_date, true) : '-',
			),
			array(
				'name'=>'creation_date',
			...
			array(
				'name'=>'headline_date',
				'value'=>!in_array($model->headline_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00')) ? Utility::dateFormat($model->headline_date, true) : '-',
			),
			array(
				'name'=>'updated_date',
