	...
	<div class="boxed">
		...
		<?php 
			...
			array_push($columnData, array(
				...
				'buttons' => array(
					'view' => array(
						'label' => Yii::t('phrase', 'Detail Article Download History'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'view',
						),
					...
					'update' => array(
						'label' => Yii::t('phrase', 'Update Article Download History'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'update',
						),
					...
					'delete' => array(
						'label' => Yii::t('phrase', 'Delete Article Download History'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'delete',
						),
