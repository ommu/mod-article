...
if ($view != null) {
	$this->params['breadcrumbs'][] = ['label' => $view->article->title, 'url' => ['admin/view', 'id' => $view->article_id]];
	$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'View'), 'url' => ['view/admin/manage', 'article' => $view->article_id]];
} else {
