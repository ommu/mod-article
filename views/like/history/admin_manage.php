...
if ($like != null) {
	...
	$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Like'), 'url' => ['like/admin/manage', 'article' => $like->article_id]];
} else {
	$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Like'), 'url' => ['like/admin/index']];
}
...
<?php if ($like != null) {
    echo $this->render('/like/admin/admin_view', ['model' => $like, 'small' => true]);
} ?>
