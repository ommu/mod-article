...
if (!$small) {
    ...
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Like'), 'url' => ['manage', 'id' => $model->article_id]];
...
$attributes = [
	...
	[
		...
		'value' => function ($model) {
			...
			return Html::a($histories, ['like/history/manage', 'like' => $model->primaryKey], ['title' => Yii::t('app', '{count} histories', ['count' => $histories])]);
		},
		'format' => 'html',
	],
	[
