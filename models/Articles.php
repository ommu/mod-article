	...
	protected function afterConstruct() 
	{
		...
		if(count($this->templateColumns) == 0) {
			...
			$this->templateColumns['published_date'] = array(
				'name' => 'published_date',
				'value' => '!in_array($data->published_date, array(\'0000-00-00 00:00:00\', \'1970-01-01 00:00:00\', \'0002-12-02 07:07:12\', \'-0001-11-30 00:00:00\')) ? Yii::app()->dateFormatter->formatDateTime($data->published_date, \'medium\', false) : \'-\'',
				'htmlOptions' => array(
					'class' => 'center',
				),
			...
			$this->templateColumns['headline_date'] = array(
				'name' => 'headline_date',
				'value' => '!in_array($data->headline_date, array(\'0000-00-00 00:00:00\', \'1970-01-01 00:00:00\', \'0002-12-02 07:07:12\', \'-0001-11-30 00:00:00\')) ? Yii::app()->dateFormatter->formatDateTime($data->headline_date, \'medium\', false) : \'-\'',
				'htmlOptions' => array(
					'class' => 'center',
				),
