 ...
 * ArticleFile
 *
 * ArticleFile represents the model behind the search form about `ommu\article\models\ArticleFiles`.
 *
...
class ArticleFile extends ArticleFiles
{
	/**
	 * {@inheritdoc}
	 */
	...
	public function search($params, $column=null)
	{
		if(!($column && is_array($column)))
			$query = ArticleFiles::find()->alias('t');
		else
			$query = ArticleFiles::find()->alias('t')->select($column);
